...
7. 启动 Egern，在“分析 → 小组件画廊”点击“国家电网·更新数据”，等待查询完成；每次需要重新查询时，都必须运行这个更新组件，而不是只刷新“国家电网·诊断”。模块也会在每天 08:15 和 18:15 自动更新。
8. 更新结束后再打开“国家电网·诊断”查看本次记录；诊断组件只读取已保存的日志，不会自行发起查询。
